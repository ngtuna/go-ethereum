...
//			}
//
//			found, ciphertext, decryptionKey, err := a.getACTDecryptionKey(ctx, storage.Key(common.Hex2Bytes(m.Access.Act)), sessionKey)
//			if err != nil {
//				return err
//			}
//			if !found {
...
//}
//
//func (a *API) getACTDecryptionKey(ctx context.Context, actManifestAddress storage.Key, sessionKey []byte) (found bool, ciphertext, decryptionKey []byte, err error) {
